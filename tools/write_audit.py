"""Generate the PIN-to-PIN forensic audit file."""
from pathlib import Path

AUDIT = r"""# PIN-TO-PIN FORENSIC AUDIT
...
Path(r"D:\unihack\AUDIT.md").write_text(AUDIT, encoding="utf-8")
print(f"Written {len(AUDIT)} chars to AUDIT.md")
